...
public class DecodeAutonomousBlueClose extends BaseDecodeAutonomous {
    ...
    public void init() {
        ...
        m_Spike1Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, 13.00, AngleUnit.DEGREES, -90);
        m_Spike2Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, -10.00, AngleUnit.DEGREES, -90);
        m_Spike3Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, -34.00, AngleUnit.DEGREES, -90);

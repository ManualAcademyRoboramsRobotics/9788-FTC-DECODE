...
public class DecodeAutonomousBlueFar extends BaseDecodeAutonomous {
    ...
    public void init() {
        ...
        m_Spike1Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, -38.00, AngleUnit.DEGREES, -90);
        m_Spike2Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, -15.00, AngleUnit.DEGREES, -90);
        m_Spike3Position = new Pose2D(DistanceUnit.INCH, AutoConstants.BLUE_SPIKE_X, 11.00, AngleUnit.DEGREES, -90);
